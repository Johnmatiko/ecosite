...
<head>
	...
	<!-- Favicon-->
	<link rel="shortcut icon" href="../nisc/img/fav.png">
	<!-- Author Meta -->
	<meta name="author" content="NISC GROUP">
	<!-- Meta Description -->
	<meta name="description" content="">
	<!-- Meta Keyword -->
	<meta name="keywords" content="Office Pc,Home Pc,office computer">
	
<title>OFFICE & HOME MONITORS</title>
<meta charset="utf-8">
...
<header class="header">
				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo"><a href="../nisc/index.html"><img src="images/Nisc_logo.png" alt="img"></div>
							<nav class="main_nav">
								<ul>
									<li class="hassubs active">
										<a href="../nisc/index.html">HOME</a>
									...
									<li><a href="../nisc/contact.html">CONTACT US</a></li>
								</ul>
							</nav>
							<div class="header_extra ml-auto">
								<div class="shopping_cart">
									<a href="../nisc/cart.html">
									...
									<div class="search_icon">
										...
										<g>
											<path d="M464.524,412.846l-97.929-97.925c23.6-34.068,35.406-72.047,35.406-113.917c0-27.218-5.284-53.249-15.852-78.087
												...
												c35.212,0,65.331,12.519,90.364,37.546c25.033,25.026,37.548,55.15,37.548,90.36C328.911,236.214,316.392,266.329,291.363,291.358z0.00
												"/>
										</g>
									</svg>
									</div>
			...
			<div class="page_menu_content">
				...
				<ul class="page_menu_nav menu_mm">
					<li class="page_menu_item has-children menu_mm">
						<a href="../nisc/index.html">HOME<i class="fa fa-angle-down"></i></a>
					...
					<li class="page_menu_item menu_mm"><a href="../nisc/index.html">OUR COMPANY<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="#">INVESTORS<i class="fa fa-angle-down"></i></a></li>
					<li class="page_menu_item menu_mm"><a href="../nisc/contact.html">CONTACTS US<i class="fa fa-angle-down"></i></a></li>
				</ul>
			</div>
		</div>
	...
	$query1=mysqli_connect("localhost","root","toor");
	mysqli_select_db($query1,"db_nisc");
	...
	$query=mysqli_query($query1, "select * from tbl_product where gen_name='Desktop' LIMIT $start, $limit");
	...
	while($query2=mysqli_fetch_array($query))
	{
		...
		echo "
							<!-- Product -->
							<div class='product'>
								<div class='product_image'><img src='/nisc/admin/Admin/item_images/".$query2['product_image']."' /></div>
								<div class='product_content'>
									<div class='product_title'><a href='productdetails.php?product_id=".$query2['product_id']."'> ".$query2['product_name']."</a></div>
									<div class='product_price'><a href='productdetails.php?product_id=".$query2['product_id']."'>View more</a></div>
								</div>
							</div>
						...
						$rows=mysqli_num_rows(mysqli_query($query1, "select * from tbl_product"));
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						...
						<div class="icon_box_text">
							<p>nisc isa potential company.</p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						...
						<div class="newsletter_text"><p>you need custom acessories we got u</p></div>
	...
	<footer class="footer">
		<div class="footer_background" style="background-image:url(../nisc/images/footer.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
