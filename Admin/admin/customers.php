...
<?php
	...
	if(isset($_GET['delete_id']))
	{
		...
		$stmt_delete = $DB_con->prepare('DELETE FROM users WHERE uid =:uid');
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <a class="btn btn-success" href="view_orders.php?view_id=<?php echo $row['uid']; ?>"><span class='glyphicon glyphicon-shopping-cart'></span> View Orders</a> 
				  <a class="btn btn-warning" href="?order_id=<?php echo $row['uid']; ?>" title="click for delete" onclick="return confirm('Are you sure to reset the customer items ordered?')">
				  <span class='glyphicon glyphicon-ban-circle'></span>
				  Reset Order</a>
				 <a class="btn btn-primary" href="previous_orders.php?previous_id=<?php echo $row['uid']; ?>"><span class='glyphicon glyphicon-eye-open'></span> Previous Items Ordered</a> 
				
				
                  <a class="btn btn-danger" href="?delete_id=<?php echo $row['uid']; ?>" title="click for delete" onclick="return confirm('Are you sure to remove this customer?')">
